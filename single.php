							...
							case 'author':
								...
								<div class="postauthor">
									...
									<div class="author-wrap">
										...
										<span class="author-posts"><a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>"><?php _e('More from this Author','sociallyviral'); ?> <i class="fa fa-angle-double-right"></i></a></span>
